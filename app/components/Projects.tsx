  ...
  const items = [
    {
      ...
      image: 'ChatGPT Image Nov 3, 2025, 12_08_20 PM.png', // add to /public/images/
    ...
    },
    {
      ...
      image: 'AI_Driven_Retail_Sales_Forecasting.png',
...

    {
      ...
      image: 'Interactive_Data_Visualization_(D3.js).png',
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {items.map((p) => (
            <article key={p.title} className="group rounded-2xl border border-slate-800 bg-slate-900/30 hover:bg-slate-900/50 transition overflow-hidden">
              <Image src={`/images/${p.image}`} alt={p.title} width={800} height={500} className="object-cover w-full h-56 md:h-64" />
              <div className="p-5">
